...
data= matrix(c("word","word","word","https://github.com/leahgreiner/homework03","word","word"), ncol=3, byrow=TRUE)
 
# specify the column names and row names of matrix
colnames(data) = c('Link','Pull Request','Name of Repository')
rownames(data) <- c('Tess','Leah')
...
```{r}
IN #%>% 
ggplot(life5060, aes(x = gdpPercap, y = lifeExp)) + geom_line()
```
